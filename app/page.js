          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 mb-12">
            <div>
              ...
              <p className="text-lg text-text-light/80 dark:text-text-dark/80 mb-6">
                Our curated daily newsletters via Telegram help students track the latest innovations, research breakthroughs, and industry trends in artificial intelligence.
              </p>
      ...
      <section id="partners" className="py-20 bg-surface-light dark:bg-surface-dark">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 items-center">
            {/* Enhance Logo Hovers */}
            <div className="flex justify-center p-4 grayscale hover:grayscale-0 hover:scale-110 transition-all duration-300 transform">
              <img 
