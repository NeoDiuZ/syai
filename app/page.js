        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
              <div className="flex items-start space-x-3">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-primary-light flex-shrink-0 mt-1">
          ...
          <div className="mt-12 text-center">
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-blue-600 via-purple-600 to-blue-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300 animate-gradient-x bg-200%"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            ...
            <div className="space-y-6">
              ...
              <div className="mt-6 text-center">
                ...
                <Link href="https://aisdc.aisingapore.org/" className="animated-gradient-button rounded-lg px-6 py-3 text-white font-semibold inline-flex items-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 mb-12">
            ...
            <div>
              ...
              <Link href="#" className="animated-gradient-button rounded-lg px-6 py-3 text-white font-semibold inline-flex items-center">
