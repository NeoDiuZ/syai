    ...
    return (
      <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 items-start max-w-md">
        ...
        <button
          type="submit"
          disabled={loading}
          className="animated-gradient-button w-full sm:w-auto rounded-lg px-6 py-3 text-white font-semibold inline-flex items-center justify-center disabled:opacity-70 disabled:cursor-not-allowed"
        >
