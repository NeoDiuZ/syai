...
const ImageCarousel = ({ images, interval = 0 }) => {
  ...
  return (
    <div className="relative w-full aspect-video bg-white/5 backdrop-blur-xl rounded-xl overflow-hidden shadow-lg">
